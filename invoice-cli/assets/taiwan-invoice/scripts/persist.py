...
PROVIDER_CONFIGS = {
    'ECPay': {
        ...
        'endpoints': {
            ...
            'void': '/B2CInvoice/Invalid',
            'allowance': '/B2CInvoice/Allowance',
            'print': '/B2CInvoice/InvoicePrint',
        },
    ...
    'SmilePay': {
        ...
        'endpoints': {
            ...
            'void': '/SPEinvoice_Storage_Modify.asp',
            'allowance': '/SPEinvoice_Storage_Allowance.asp',
        },
    ...
    'Amego': {
        ...
        'endpoints': {
            'issue': '/json/f0401',
            'void': '/json/f0501',
            'allowance': '/json/g0401',
            'print': '/json/invoice_print',
        },
