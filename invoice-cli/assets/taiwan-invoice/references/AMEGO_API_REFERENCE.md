...
| `21` | 人數過多，請稍後 |
| `22` | 尚未申請 API 串接 |
| `23` | 此 API 支援傳輸多筆資料，data 欄位資料應為陣列字串 |
...
| `3040162` | 只有打統編發票，才可以用未稅單價及小計 |
| `3040171` | OrderId 重複（或該訂單編號正在註銷重開中） |
...
作廢、折讓、查詢等 API 的代碼請查 `data/error-codes.csv`（`category` 欄標示所屬 API）。
