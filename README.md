...
**最新版本（請以 npm 為準）：**
- `taiwan-invoice-skill@2.9.5+` — 9 家發票（ECPay / SmilePay / Amego / ezPay / PayNow / O'Pay / SunPay / 財政部大平台 / 關貿）
- `taiwan-payment-skill@1.5.6+` — 14 家金流（ECPay / NewebPay / PAYUNi / SmilePay / PChomePay / ezPay / PayNow / Shopline / LINE Pay / TapPay / O'Pay / 街口 / 紅陽 / GoMyPay）
- `taiwan-logistics-skill@1.4.5+` — 11 家可串接物流（7 aggregator + HCT 直連 + 3 家即時配送）＋ 10 家僅供查詢
